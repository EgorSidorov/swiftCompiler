...
%3 = call i8* @"\01??2@YAPEAX_K@Z"(i64 24) #7
  
%4 = bitcast i8* %3 to %class.LinkedList*
  
store %class.LinkedList* %4, %class.LinkedList** %2, align 8
  
%5 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?initial@LinkedList@@QEAAXXZ"(%class.LinkedList* %5)
  
%6 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?setcurrentvalue@LinkedList@@QEAAXXZ"(%class.LinkedList* %6, i32 2)
  
%7 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?push@LinkedList@@QEAAXXZ"(%class.LinkedList* %7, i32 5)
  
%8 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?push@LinkedList@@QEAAXXZ"(%class.LinkedList* %8, i32 11)
  
%9 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?printall@LinkedList@@QEAAXXZ"(%class.LinkedList* %9)
  
%10 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?revert@LinkedList@@QEAAXXZ"(%class.LinkedList* %10)
  
%11 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?printall@LinkedList@@QEAAXXZ"(%class.LinkedList* %11)
 
%12 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?revert@LinkedList@@QEAAXXZ"(%class.LinkedList* %12)
  
%13 = load %class.LinkedList*, %class.LinkedList** %2, align 8
  
call void @"\01?printall@LinkedList@@QEAAXXZ"(%class.LinkedList* %13)
  ret i32 0
}



declare noalias i8* @"\01??2@YAPEAX_K@Z"(i64)
...
declare i32 @__stdio_common_vfprintf(i64, %struct._iobuf*, i8*, %struct.__crt_locale_pointers*, i8*) 
